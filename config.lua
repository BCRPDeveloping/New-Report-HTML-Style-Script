...
Config.FeedbackClientCommand = 'help' -- The command that the players use to report something

Config.FeedbackAdminCommand = 'check_helps' -- The command that the admins use to check the pendent feedbacks list
...
Config.BotName = 'Put' -- Write the desired bot name

Config.ServerName = 'Put' -- Write your server's name
